...
For the model see the file `LogisticRegression.stan`. Next we run VB

```{r}
LRModel <- stan_model(file='LogisticRegression.stan')
vb(LRModel,data=biopsy_dat,init='0',algorithm='meanfield')
```
